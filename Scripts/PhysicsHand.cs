...
public class PhysicsHand : MonoBehaviour
{
    ...
    void HookesLaw()
    {
        ...
        double hitPower = Mathf.Abs(force[0] +  force[1] +  force[2]); 
        if(Time.time > punchtimer && hitPower > 10){
            punchtimer = Time.time + 0.3;
                source.volume = (float)hitPower / 100;  
